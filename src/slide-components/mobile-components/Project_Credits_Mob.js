...
class ProjectCreditsMobile extends Component {
  plotree = () => {
  ...
  render () {
    return (
      <div className={styles.project_credits_container} style={{height: window.innerHeight}}>
...
export default ProjectCreditsMobile;
